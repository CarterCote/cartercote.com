...
const projects = [
  ...
  },
  {
    ...
    year: "2024",
    description: "Enabling content creators with AI tools to go viral at 10x the speed, with stylized, captioned, and animated short-form content. 0 to 2m users.",
  ...
  },
  {
    ...
    role: "Founding Designer",
    year: "2023",
    description: "Emerging AI tools for 5M+ users to rapidly create new music, saving precious time for true creativity. Designed the UI and branding for v2 of the platform.",
