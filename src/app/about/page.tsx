...
const BioContent = () => (
  <div className="w-full font-aeonik-regular space-y-8 text-[18px]">
    ...
    <P>musicfy took advantage of the noise around AI music after GPT launched. the hook was simple: sing like your favorite artist. crayo gave me the opportunity to design a product alongside the two largest names in the clipping space. sellraze granted a ton of insight into the pain-points in e-commerce, as well as the longterm challenges of building in the space. those ingredients eventually came in handy for my latest role.</P>
