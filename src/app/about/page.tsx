...
const BioContent = () => (
  <div className="w-full font-aeonik-regular space-y-8 text-[18px]">
    ...
    <P>i learned a lot. and did a lot. each role had its own responsibilities and learnings. each team i worked with hit 7-figures ARR. i was building the set of tools i needed to design, build, and scale anything.</P>
