...
const BioContent = () => (
  <div className="w-full font-aeonik-regular space-y-8 text-[18px]">
    ...
    <P>then, after a few freelance gigs, I got frustrated with not having full creative control over how websites looked and functioned. that frustation pushed me to study CS at Georgia Tech.</P>
    ...
    <P>but building in edtech felt daunting. there were endless variables outside of my control.</P>
    <P>disheartened, I went to Georgia Tech to explore other interests, with the hope of eventually coming back to education. beyond CS, I studied Industrial Design and Cognitive Psychology.</P>
    <P>i joined a research lab, interned at startups and big companies, and explored interests like growth & photography. i even had the chance to take photos for LeBron James Jr., NLE Choppa, Vic Blends, Georgia Tech's Football Team, and more.</P>
    <Subtitle>by junior year in college, I felt experienced but unfulfilled. I felt lost in my pursuit of the original goal to build software and help people.</Subtitle>
    ...
    <P>each project taught me something different—distribution, product velocity, long-term challenges in e-commerce. together, they shaped how i think about building.</P>
    <P>this chapter allowed me to fully support myself while navigating financial struggles back home. i avoided an eviction notice and overcame over $30,000 of credit card debt.</P>
    <P>working with these teams allowed me to build the set of tools i needed to design, build, and scale anything. each role had its own responsibilities and learnings. each team hit 7-figures ARR.</P>
    ...
    <P>over 50k students at over 40 universities have attended a startup exchange event since fall 2022. we had dozens of partners (the City of Atlanta, Google, Nvidia, Meta, 50+ more), flew out investors from SF, curated the first AI and XR hackathons in Atlanta, and raised over $150,000.</P>
    <P>i even became a finalist for Mr. Georgia Tech and got recognized by the city because of sx. i felt so honored to be in a position to amplify the community and their stories.</P>
    <P>my close friend vik and I traveled across the US to host sx events. we wanted to build a movement, a culture of finding yourself and finding your people during the insanely long, intimidating journey of building something.</P>
    ...
    <P>so, i logged over 60 flights in 2025 to fly back and forth between NY and SF, committing to building Phia while I finished my degree. i have since graduated, and the story continues to be written.</P>
