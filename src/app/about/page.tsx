...
const BioContent = () => (
  <div className="w-full font-aeonik-regular space-y-8 text-[18px]">
    ...
    <P>things changed pretty quickly for me when I had the unique opportunity to build Phia and to redefine the shopping category in consumer. i logged over 60 flights in 2025 to fly back and forth between NY and SF to build Phia and to finish my degree. the story continues to be written.</P>
