...
export const experiences = [
  ...
  },
  {
    ...
    roleDescription:
      "Devised UX strategy to attract university students to Overtime events, driving digital engagement & sales conversions to grow from <5% to 15% of overall event attendance. Launched ambassador program.",
  },
  {
    ...
    roleDescription:
      "Automated compatibility testing by training and deploying multimodal classifiers, reducing manual testing by 90%. Developed a summarization tool and a high-volume ML inference API.",
  },
  {
    ...
    roleDescription:
      "Designed web components and assets for strategic projects. Backed by a16z, Audacious Ventures, Gary Tan.",
  },
  {
    position: "SOFTWARE ENGINEER",
    year: "2022",
    ...
    roleDescription:
      "Developed an end-to-end API system for scalable resiliency tasks for large transactions, and built a client-facing UI for automated task management used by 5000+ developers.",
  },
];
